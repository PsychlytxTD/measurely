  ...
  tagList(
    ...
    wellPanel(style = "background-color: #ededed; color: black",
              ...
              fluidRow(
                ...
                column(width = 2, radioButtons(ns("item_1"), label = NULL, choices = c("YES" = "0", "NO" = "1"), inline = TRUE, selected = character(0)))
              ),
              fluidRow(style = "background-color: #ffffff",
                       column(width = 10, h4("2.	Have you dropped many of your activities and interests?")),
                       column(width = 2, radioButtons(ns("item_2"), label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
              ),
              fluidRow(
                column(width = 10, h4("3. Do you feel that your life is empty?")),
                column(width = 2, radioButtons(ns("item_3"), label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
              ),
              fluidRow(style = "background-color: #ffffff",
                       column(width = 10, h4("4. Do you often get bored?")),
                       column(width = 2, radioButtons(ns("item_4"), label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
              ),
              fluidRow(
                column(width = 10, h4("5. Are you in good spirits most of the time? ")),
                column(width = 2, radioButtons(ns("item_5"), label = NULL, choices = c("YES" = "0", "NO" = "1"), inline = TRUE, selected = character(0)))
              ),
              fluidRow(style = "background-color: #ffffff",
                       column(width = 10, h4("6.	Are you afraid that something bad is going to happen to you?")),
                       column(width = 2, radioButtons(ns("item_6"), label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
              ),
              fluidRow(
                column(width = 10, h4("7. Do you feel happy most of the time?")),
                column(width = 2, radioButtons(ns("item_7"), label = NULL, choices = c("YES" = "0", "NO" = "1"), inline = TRUE, selected = character(0)))
              ),
              fluidRow(style = "background-color: #ffffff",
                       column(width = 10, h4("8. Do you often feel helpless?")),
                       column(width = 2, radioButtons(ns("item_8"), label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
              ),
              fluidRow(
                column(width = 10, h4("9. Do you prefer to stay at home, rather than going out and doing new things?")),
                column(width = 2, radioButtons(ns("item_9"), label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
              ),
              fluidRow(style = "background-color: #ffffff",
                       column(width = 10, h4("10. Do you feel you have more problems with memory than most?")),
                       column(width = 2, radioButtons(ns("item_10"), label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
              ),
              fluidRow(
                column(width = 10, h4("11. Do you think it is wonderful to be alive now?")),
                column(width = 2, radioButtons(ns("item_11"), label = NULL, choices = c("YES" = "0", "NO" = "1"), inline = TRUE, selected = character(0)))
              ),
              fluidRow(style = "background-color: #ffffff",
                       column(width = 10, h4("12. Do you feel pretty worthless the way you are now? ")),
                       column(width = 2, radioButtons(ns("item_12"), label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
              ),
              fluidRow(
                column(width = 10, h4("13. Do you feel full of energy?")),
                column(width = 2, radioButtons(ns("item_13"), label = NULL, choices = c("YES" = "0", "NO" = "1"), inline = TRUE, selected = character(0)))
              ),
              fluidRow(style = "background-color: #ffffff",
                       column(width = 10, h4("14. Do you feel that your situation is hopeless?")),
                       column(width = 2, radioButtons(ns("item_14"), label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
              ),
              fluidRow(
                column(width = 10, h4("15. Do you think that most people are better off than you are?")),
                column(width = 2, radioButtons(ns("item_15"), label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
              ),
              fluidRow(
...
#'@export
#'
gds15_scale<- function(input, output, session) {
