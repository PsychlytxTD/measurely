...
pdsssr_scale_UI<- function(id) {
  ...
  tagList(
    ...
    wellPanel(style = "background-color: #ffffff; color: black",
              ...
              fluidRow(
                column(width = 12, radioButtons(ns("item_1"), label = NULL, choices = c("0. No panic or limited symptom episodes" = "0",
                                                                                       ...
                                                                                       "4. Extreme: full panic attacks occurred more than once a day, more days than not" = "4"), selected = character(0)))
              ),
              ...
              fluidRow(
                column(width = 12, radioButtons(ns("item_2"), label = NULL, choices = c("0. Not at all distressing, or no panic or limited symptom attacks during the past week" = "0",
                                                                                       ...
                                                                                       "4. Extremely distressing (extreme distress during all attacks)" = "4"), selected = character(0)))
               ),
              ...
              fluidRow(
                column(width = 12, radioButtons(ns("item_3"), label = NULL, choices = c("0. Not at all" = "0",
                                                                                       "1. Occasionally or only mildly" = "1",
                                                                                       "2. Frequently or moderately" = "2",
                                                                                       "3. Very often or to a very disturbing degree" = "3",
                                                                                       "4. Nearly constantly and to a disabling extent" = "4"), selected = character(0)))
               ),
              ...
              fluidRow(
                column(width = 12, radioButtons(ns("item_4"), label = NULL,
                                      ...
                                      such that important tasks were not performed." = "4"), selected = character(0)))
              ...
              fluidRow(
                column(width = 12, radioButtons(ns("item_5"), label = NULL,
                                      ...
                                      such that important tasks or activities were not performed." = "4"), selected = character(0)))
              ...
              fluidRow(
                column(width = 12, radioButtons(ns("item_6"), label = NULL,
...
responsibilities." = "4"
              ...
              fluidRow(
                column(width = 12, radioButtons(ns("item_7"), label = NULL, choices = c("0. No interference" = "0",
