GAD_7<- list(  title = "Generalized Anxiety Disorder 7-Item Scale (GAD-7)", #Title can contain white space. For insertion into widget headings, plot titles etc.
                   ...
                   cutoff_values = list(c(5, 10, 15, 3.01, 3.01 + 3.12, 3.01 + (2 * 3.12)), c(5, 10, 15, 4.07, 4.07 + 3.53, 4.07 + (2 * 3.53)),
                                        c(5, 10, 15, 2, 2 + 2.88, 2 + (2 * 2.88)), c(5, 10, 15, 4.75, 4.75 + 4.76, 4.75 + (2 *4.76)),
                   ...
                   cutoff_labels = list(c("Mild", "Moderate", "Severe", "Mean", "Mean + 1 Sd", "Mean + 2 Sd"), c("Mild", "Moderate", "Severe", "Mean", "Mean + 1 Sd", "Mean + 2 Sd"),
                   ...
                   cutoff_references = list(c("Spitzer, Kroenke, Williams & Löwe (2006)", "Spitzer, Kroenke, Williams & Löwe (2006)", "Spitzer, Kroenke, Williams & Löwe (2006)",
                                            ...
                                            c("Spitzer, Kroenke, Williams & Löwe (2006)", "Spitzer, Kroenke, Williams & Löwe (2006)", "Spitzer, Kroenke, Williams & Löwe (2006)",
                                              "Dear, Titov, Sunderland, McMillan, Anderson, Lorian & Robinson (2011)",
                                            ...
                                            c("Spitzer, Kroenke, Williams & Löwe (2006)", "Spitzer, Kroenke, Williams & Löwe (2006)", "Spitzer, Kroenke, Williams & Löwe (2006)",
                                              ...
                                              "Fenwick, Rees, Homes-Truscott, Browne, Pouwer & Speight (2016)"),
                                            c("Spitzer, Kroenke, Williams & Löwe (2006)", "Spitzer, Kroenke, Williams & Löwe (2006)", "Spitzer, Kroenke, Williams & Löwe (2006)",
                                              "Fenwick, Rees, Homes-Truscott, Browne, Pouwer & Speight (2016)" , "Fenwick, Rees, Homes-Truscott, Browne, Pouwer & Speight (2016)",
                                              "Fenwick, Rees, Homes-Truscott, Browne, Pouwer & Speight (2016)"),
                                            c("Spitzer, Kroenke, Williams & Löwe (2006)", "Spitzer, Kroenke, Williams & Löwe (2006)", "Spitzer, Kroenke, Williams & Löwe (2006)",
                                              "Schmid, Arnold, Jones, Ritter, Sapp & Van Puymbroeck (2015)" , "Schmid, Arnold, Jones, Ritter, Sapp & Van Puymbroeck (2015)",
                                              "Schmid, Arnold, Jones, Ritter, Sapp & Van Puymbroeck (2015)"),
                   ...
                   plot_cutoff_label_start = 0.2, #Indicates how far above the cutoff value the text cutoff label starts
                   plot_cutoff_label_size = 4,
