EDPS<- list(  title = "Edinburgh Postnatal Depression Scale (EDPS)", #Title can contain white space. For insertion into widget headings, plot titles etc.
               ...
               populations = list("Female_Antepartum", "Female_Postpartum", "Male_Postpartum", "Other"),
               means = list(3.65, 3.77, 4.35, 0),
               sds = list(2.62, 3.31, 3.72, 0),
               mean_sd_references = list("Venkatesh, Kaimal, Castro & Perslis (2017)", "Venkatesh, Kaimal, Castro & Perslis (2017)",
                                         "Matthey, Barnett, Kavanagh & Howie (2001)", "Define Value"),
               reliabilities = list(.92, .92, .92, 0),
               reliability_references = list("Kernot, Olds, Lewis & Maher (2015)", "Kernot, Olds, Lewis & Maher (2015)",
                                             "Kernot, Olds, Lewis & Maher (2015)", "Define Value"),
               cutoff_values = list(
