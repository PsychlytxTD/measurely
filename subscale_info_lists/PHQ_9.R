PHQ_9<- list(  title = "Primary Health Questionnaire (PHQ-9)", #Title can contain white space. For insertion into widget headings, plot titles etc.
               ...
               mean_sd_references = list("Kocalevent, Hinz & Brahler (2013)", "Kocalevent, Hinz & Brahler (2013)", "Kocalevent, Hinz & Brahler (2013)",
                                         "Kocalevent, Hinz & Brahler (2013)", "Kocalevent, Hinz & Brahler (2013)", "Kocalevent, Hinz & Brahler (2013)",
                                         "Kocalevent, Hinz & Brahler (2013)", "Jordan, Shedden-Mora & Lowe (2017)", "Gilbody, Littlewood, Hewitt, Brierley et al (2015)",
               ...
               reliability_references = list("Lowe, Unutzer, Callahan, Perkins & Kroenke (2004)", "Lowe, Unutzer, Callahan, Perkins & Kroenke (2004)",
                                             "Lowe, Unutzer, Callahan, Perkins & Kroenke (2004)", "Lowe, Unutzer, Callahan, Perkins & Kroenke (2004)",
                                             "Lowe, Unutzer, Callahan, Perkins & Kroenke (2004)", "Lowe, Unutzer, Callahan, Perkins & Kroenke (2004)",
                                             "Lowe, Unutzer, Callahan, Perkins & Kroenke (2004)", "Lowe, Unutzer, Callahan, Perkins & Kroenke (2004)",
                                             "Lowe, Unutzer, Callahan, Perkins & Kroenke (2004)", "Lowe, Unutzer, Callahan, Perkins & Kroenke (2004)",
                                             "Lowe, Unutzer, Callahan, Perkins & Kroenke (2004)", "Lowe, Unutzer, Callahan, Perkins & Kroenke (2004)",
               ...
               cutoff_values = list(c(10, 15, 20, 2.3, 2.3 + 3.3, 2.3 + (2 * 3.3)),
                                    ...
                                    c(10, 15, 20, 2.6, 2.6 + 3.5, 2.6 + (3 * 3.5)),
                                    c(10, 15, 20, 2.8, 2.8 + 3.5, 2.8 + (3 * 3.5)),
                                    c(10, 15, 20, 3.2, 3.2 + 3.5, 3.2 + (3 * 3.5)),
                                    c(10, 15, 20, 3.3, 3.3 + 3.6, 3.3 + (2.5 * 3.6)),
                                    c(10, 15, 20, 4.4, 4.4 + 3.9, 4.4 + (2 * 3.9)),
                                    c(10, 15, 20, 5.2, 5.2 + 4.75, 5.2 + (2.5 * 4.75)),
                                    c(10, 15, 20, 16.65, 16.65 + (1.5 * 4.25), 16.65 + (2 * 4.25)),
                                    c(10, 15, 20, 4.84, 4.84 + (1.5 * 5.69), 4.84 + (2 * 5.69)),
                                    c(10, 15, 20, 7.95, 7.95 - (2.5 * 0.46), 7.95 + (2 * 0.46)),
                                    c(10, 15, 20, 9.1, 9.1 + (1.5 * 6.3), 9.1 + (2 * 6.3)),
                                    c(10, 15, 20, 13, 13 + (0.5 * 6.7), 13 + (2 * 6.7)),
                                    c(10, 15, 20, 7.42, 7.42 + 6, 7.42 + (1.5 * 6)),
                                    c(0, 0, 0, 0, 0, 0)),
               cutoff_labels = list(c("Major Depressive Episode", "Moderately Severe Depression", "Severe Depression",
                                    ...
                                    c("Major Depressive Episode", "Moderately Severe Depression", "Severe Depression",
                                      "Mean", "Mean + 1 Sd", "Mean + 2 Sd"),
                                    c("Major Depressive Episode", "Moderately Severe Depression", "Severe Depression",
                                      "Mean", "Mean + 1 Sd", "Mean + 3 Sd"),
                                    c("Major Depressive Episode", "Moderately Severe Depression", "Severe Depression",
                                      "Mean", "Mean + 1 Sd", "Mean + 3 Sd"),
                                    c("Major Depressive Episode", "Moderately Severe Depression", "Severe Depression",
                                      "Mean", "Mean + 1 Sd", "Mean + 3 Sd"),
                                    c("Major Depressive Episode", "Moderately Severe Depression", "Severe Depression",
                                      "Mean", "Mean + 1 Sd", "Mean + 2.5 Sd"),
                                    c("Major Depressive Episode", "Moderately Severe Depression", "Severe Depression",
                                      "Mean", "Mean + 1 Sd", "Mean + 2 Sd"),
                                    c("Major Depressive Episode", "Moderately Severe Depression", "Severe Depression",
                                      "Mean", "Mean + 1 Sd", "Mean + 2.5 Sd"),
                                    c("Major Depressive Episode", "Moderately Severe Depression", "Severe Depression",
                                      "Mean", "Mean + 1.5 Sd", "Mean + 2 Sd"),
                                    c("Major Depressive Episode", "Moderately Severe Depression", "Severe Depression",
                                      "Mean", "Mean + 1.5 Sd", " Mean + 2 Sd"),
                                    c("Major Depressive Episode", "Moderately Severe Depression", "Severe Depression",
                                      "Mean", "Mean - 2.5 Sd", "Mean + 2 Sd"),
                                    c("Major Depressive Episode", "Moderately Severe Depression", "Severe Depression",
                                      "Mean", "Mean + 1.5 Sd", "Mean + 2 Sd"),
                                    c("Major Depressive Episode", "Moderately Severe Depression", "Severe Depression",
                                      "Mean", "Mean + 0.5 Sd", "Mean + 2 Sd"),
                                    c("Major Depressive Episode", "Moderately Severe Depression", "Severe Depression",
                                      "Mean", "Mean + 1 Sd", "Mean + 1.5 Sd"),
               ...
               cutoff_references = list(
                 ...
                 c("Kroenke, Spitzer & Williams (2001)", "Kroenke, Spitzer & Williams (2001)", "Kroenke, Spitzer & Williams (2001)",
                   "Kocalevent, Hinz & Brahler (2013)", "Kocalevent, Hinz & Brahler (2013)", "Kocalevent, Hinz & Brahler (2013)"),
                 c("Kroenke, Spitzer & Williams (2001)", "Kroenke, Spitzer & Williams (2001)", "Kroenke, Spitzer & Williams (2001)",
                   "Jordan, Shedden-Mora & Lowe (2017)", "Jordan, Shedden-Mora & Lowe (2017)", "Jordan, Shedden-Mora & Lowe (2017)"),
                 c("Kroenke, Spitzer & Williams (2001)", "Kroenke, Spitzer & Williams (2001)", "Kroenke, Spitzer & Williams (2001)",
