GDS_15<- list(  title = "Geriatric Depression Scale - 15 (GDS-15)", #Title can contain white space. For insertion into widget headings, plot titles etc.
               ...
               populations = list("General_Population", "Over_85_Years", "Experiencing_Functional_Impairment", "Dementia", "Other"),
               means = list(1.28, 3.7, 4.34, 3.11, 0),
               sds = list(1.76, 2.6, 2.98, 2.64, 0),
               ...
               cutoff_labels = list(c("Mean", "Mean + 1 Sd", "Mean + 2 Sd", "Depression", "Mean + 3 Sd", "Mean + 4 Sd"),
                                    c("Depression", "Mean", "Mean + 1.5 Sd", "Mean + 2 Sd", "Mean + 3 Sd", "Mean + 4 Sd"),
