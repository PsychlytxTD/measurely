                ...
                fluidRow(
                  ...
                  tabBox(id = "tabset", width = 12,
                         ...
                         tabPanel(tags$strong("Complete Measure"),
                                  ...
                                  psychlytx::format_ssd12_responses_for_email_UI("format_responses_for_email"),
...
server <- function(input, output, session) {
  ...
  scale_entry<- callModule(psychlytx::ssd12_scale, "ssd12_scale", selected_client) #Return the raw responses to the online scale
