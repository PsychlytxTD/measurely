...
subscale_info_1<- global_subscale_info[["SSD_12"]] #Subset the global list to retrive the subscale list(s) for this particular measure
                ...
                fluidRow(
                  ...
                  tabBox(id = "tabset", width = 12,
                         ...
                         tabPanel(tags$strong("Complete Measure"), 
                                  ...
                                  psychlytx::format_ssd12_responses_for_email_UI("format_repsonses_for_email"),
...
server <- function(input, output, session) {
  ...
  scale_entry<- callModule(psychlytx::ssd12_scale, "ssd12_scale") #Return the raw responses to the online scale
...
#_______________________________________________________________________________Currently, the code in between hashes must be written for each subscale 
  ...
  formatted_response_body_for_email<- callModule(psychlytx::format_ssd12_responses_for_email, "format_repsonses_for_email", pool, clinician_email, manual_entry, measure_data)
