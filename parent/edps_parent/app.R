                ...
                fluidRow(
                  ...
                  tabBox(id = "tabset", width = 12,
                         ...
                         tabPanel(tags$strong("Complete Measure"), 
                                  ...
                                  psychlytx::format_edps_responses_for_email_UI("format_reponses_for_email"),
...
#_______________________________________________________________________________Currently, the code in between hashes must be written for each subscale 
  ...
  formatted_response_body_for_email<- callModule(psychlytx::format_edps_responses_for_email, "format_reponses_for_email", pool, clinician_email, manual_entry, measure_data)
