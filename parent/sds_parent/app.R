                ...
                fluidRow(
                  ...
                  tabBox(id = "tabset", width = 12,
                         ...
                         tabPanel(tags$strong("Complete Measure"),
                                  ...
                                  psychlytx::sds_scale_UI("sds_scale"), #Item of the specific measure
...
server <- function(input, output, session) {
  ...
  scale_entry<- callModule(psychlytx::sds_scale, "sds_scale", selected_client) #Return the raw responses to the online scale
