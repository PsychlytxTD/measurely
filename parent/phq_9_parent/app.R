                ...
                fluidRow(
                  ...
                  tabBox(id = "tabset", width = 12,
                         ...
                         tabPanel(tags$strong("Complete Measure"),
                                  ...
                                  psychlytx::phq9_scale_UI("phq9_scale"), #Item of the specific measure
...
server <- function(input, output, session) {
  ...
  scale_entry<- callModule(psychlytx::phq9_scale, "phq9_scale", selected_client) #Return the raw responses to the online scale
