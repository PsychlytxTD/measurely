                ...
                fluidRow(
                  ...
                  tabBox(id = "tabset", width = 12,
                         ...
                         tabPanel(tags$strong("Complete Measure"),
                                  ...
                                  psychlytx::sias_scale_UI("sias_scale"), #Item of the specific measure
...
server <- function(input, output, session) {
  ...
  scale_entry<- callModule(psychlytx::sias_scale, "sias_scale", selected_client) #Return the raw responses to the online scale
