...
server <- function(input, output, session) {
  ...
  formatted_response_body_for_email<- callModule(psychlytx::format_gad7_responses_for_email, "format_repsonses_for_email", manual_entry, simplified_measure_data)
