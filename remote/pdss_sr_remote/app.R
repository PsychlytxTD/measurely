                ...
                fluidRow(
                  ...
                  tabBox(id = "tabset", width = 12,
                         ...
                         tabPanel(psychlytx::simplified_show_name_UI("show_name"),
                                  ...
                                  psychlytx::simplified_pdsssr_scale_UI("pdsssr_scale"), #Item of the specific measure
...
server <- function(input, output, session) {
  ...
  scale_entry<- callModule(psychlytx::simplified_pdsssr_scale, "pdsssr_scale", client_id) #Return the raw responses to the online scale
