                ...
                fluidRow(
                  ...
                  tabBox(id = "tabset", width = 12,
                         ...
                         tabPanel(psychlytx::simplified_show_name_UI("show_name"),
                                  ...
                                  psychlytx::simplified_sps_scale_UI("sps_scale"), #Item of the specific measure
                                  
                                  psychlytx::manual_data_UI("manual_data"), #Items of the specific measure are passed here as a string of numbers
                                  
                                  psychlytx::format_sps_responses_for_email_UI("format_responses_for_email"),
...
server <- function(input, output, session) {
  ...
  scale_entry<- callModule(psychlytx::simplified_sps_scale, "sps_scale", client_id) #Return the raw responses to the online scale
  ...
  formatted_response_body_for_email<- callModule(psychlytx::format_sps_responses_for_email, "format_responses_for_email", pool, clinician_email, manual_entry, measure_data)
