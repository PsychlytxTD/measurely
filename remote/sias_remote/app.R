...
subscale_info_1<- global_subscale_info[["SIAS"]] #Subset the global list to retrive the subscale list(s) for this particular measure
                ...
                fluidRow(
                  ...
                  tabBox(id = "tabset", width = 12,
                         ...
                         tabPanel(psychlytx::simplified_show_name_UI("show_name"),
                                  ...
                                  psychlytx::simplified_sias_scale_UI("sias_scale"), #Item of the specific measure
...
server <- function(input, output, session) {
  ...
  scale_entry<- callModule(psychlytx::simplified_sias_scale, "sias_scale", client_id) #Return the raw responses to the online scale
