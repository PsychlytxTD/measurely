                ...
                fluidRow(
                  ...
                  tabBox(id = "tabset", width = 12,
                         ...
                         tabPanel(psychlytx::simplified_show_name_UI("show_name"),
                                  ...
                                  psychlytx::gds15_scale_UI("gds15_scale"), #Item of the specific measure
...
server <- function(input, output, session) {
  ...
  scale_entry<- callModule(psychlytx::gds15_scale, "gds15_scale", simplified = TRUE) #Return the raw responses to the online scale
