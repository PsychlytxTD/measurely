...
client_id<- "59024177-5c50-4214-a16c-b12928760876"#"810695bf-a00e-473d-b798-9767455dd030"
...
server <- function(input, output, session) {
  ...
  scale_entry<- callModule(psychlytx::gad7_scale, "gad7_scale", simplified = TRUE) #Return the raw responses to the online scale
