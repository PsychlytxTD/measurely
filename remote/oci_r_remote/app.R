                ...
                fluidRow(
                  ...
                  tabBox(id = "tabset", width = 12,
                         ...
                         tabPanel(psychlytx::simplified_show_name_UI("show_name"),
                                  ...
                                  psychlytx::simplified_ocir_scale_UI("ocir_scale"), #Item of the specific measure
...
server <- function(input, output, session) {
  ...
  scale_entry<- callModule(psychlytx::simplified_ocir_scale, "ocir_scale", client_id) #Return the raw responses to the online scale
  ...
  mean_input_2<- do.call(callModule, c(psychlytx::generate_simplified_mean_widget, "mean_widget_2", subscale_number = 2, statistic_type = "mean", holding_data))
  sd_input_2<- do.call(callModule, c(psychlytx::generate_simplified_sd_widget, "sd_widget_2",  subscale_number = 2, statistic_type = "sd", holding_data))
  reliability_input_2<- do.call(callModule, c(psychlytx::generate_simplified_reliability_widget, "reliability_widget_2", subscale_number = 2, statistic_type = "reliability", 
                                              holding_data))
  cutoff_input_2<- do.call(callModule, c(psychlytx::generate_simplified_cutoff_widget, "cutoff_widget_2", subscale_number = 2, holding_data))
  
  #Create list of input values for a subscale 
  
  input_list_2<- callModule(psychlytx::simplified_collect_holding_input, "collect_input_2", holding_data, manual_entry, aggregate_scores, mean_input_2, sd_input_2, reliability_input_2, 
                            confidence, method, cutoff_input_2, subscale_number = 2)
  ...
  mean_input_3<- do.call(callModule, c(psychlytx::generate_simplified_mean_widget, "mean_widget_3", subscale_number = 3, statistic_type = "mean", holding_data))
  sd_input_3<- do.call(callModule, c(psychlytx::generate_simplified_sd_widget, "sd_widget_3",  subscale_number = 3, statistic_type = "sd", holding_data))
  reliability_input_3<- do.call(callModule, c(psychlytx::generate_simplified_reliability_widget, "reliability_widget_3", subscale_number = 3, statistic_type = "reliability", 
                                              holding_data))
  cutoff_input_3<- do.call(callModule, c(psychlytx::generate_simplified_cutoff_widget, "cutoff_widget_3", subscale_number = 3, holding_data))
  
  #Create list of input values for a subscale 
  
  input_list_3<- callModule(psychlytx::simplified_collect_holding_input, "collect_input_3", holding_data, manual_entry, aggregate_scores, mean_input_3, sd_input_3, reliability_input_3, 
                            confidence, method, cutoff_input_3, subscale_number = 3)
  ...
  mean_input_4<- do.call(callModule, c(psychlytx::generate_simplified_mean_widget, "mean_widget_4", subscale_number = 4, statistic_type = "mean", holding_data))
  sd_input_4<- do.call(callModule, c(psychlytx::generate_simplified_sd_widget, "sd_widget_4",  subscale_number = 4, statistic_type = "sd", holding_data))
  reliability_input_4<- do.call(callModule, c(psychlytx::generate_simplified_reliability_widget, "reliability_widget_4", subscale_number = 4, statistic_type = "reliability", 
                                              holding_data))
  cutoff_input_4<- do.call(callModule, c(psychlytx::generate_simplified_cutoff_widget, "cutoff_widget_4", subscale_number = 4, holding_data))
  
  #Create list of input values for a subscale 
  
  input_list_4<- callModule(psychlytx::simplified_collect_holding_input, "collect_input_4", holding_data, manual_entry, aggregate_scores, mean_input_4, sd_input_4, reliability_input_4, 
                            confidence, method, cutoff_input_4, subscale_number = 4)
  ...
  mean_input_5<- do.call(callModule, c(psychlytx::generate_simplified_mean_widget, "mean_widget_5", subscale_number = 5, statistic_type = "mean", holding_data))
  sd_input_5<- do.call(callModule, c(psychlytx::generate_simplified_sd_widget, "sd_widget_5",  subscale_number = 5, statistic_type = "sd", holding_data))
  reliability_input_5<- do.call(callModule, c(psychlytx::generate_simplified_reliability_widget, "reliability_widget_5", subscale_number = 5, statistic_type = "reliability", 
                                              holding_data))
  cutoff_input_5<- do.call(callModule, c(psychlytx::generate_simplified_cutoff_widget, "cutoff_widget_5", subscale_number = 5, holding_data))
  
  #Create list of input values for a subscale 
  
  input_list_5<- callModule(psychlytx::simplified_collect_holding_input, "collect_input_5", holding_data, manual_entry, aggregate_scores, mean_input_5, sd_input_5, reliability_input_5, 
                            confidence, method, cutoff_input_5, subscale_number = 5)
  ...
  mean_input_6<- do.call(callModule, c(psychlytx::generate_simplified_mean_widget, "mean_widget_6", subscale_number = 6, statistic_type = "mean", holding_data))
  sd_input_6<- do.call(callModule, c(psychlytx::generate_simplified_sd_widget, "sd_widget_6",  subscale_number = 6, statistic_type = "sd", holding_data))
  reliability_input_6<- do.call(callModule, c(psychlytx::generate_simplified_reliability_widget, "reliability_widget_6", subscale_number = 6, statistic_type = "reliability", 
                                              holding_data))
  cutoff_input_6<- do.call(callModule, c(psychlytx::generate_simplified_cutoff_widget, "cutoff_widget_6", subscale_number = 6, holding_data))
  ...
  mean_input_7<- do.call(callModule, c(psychlytx::generate_simplified_mean_widget, "mean_widget_7", subscale_number = 7, statistic_type = "mean", holding_data))
  sd_input_7<- do.call(callModule, c(psychlytx::generate_simplified_sd_widget, "sd_widget_7",  subscale_number = 7, statistic_type = "sd", holding_data))
  reliability_input_7<- do.call(callModule, c(psychlytx::generate_simplified_reliability_widget, "reliability_widget_7", subscale_number = 7, statistic_type = "reliability", 
                                              holding_data))
  cutoff_input_7<- do.call(callModule, c(psychlytx::generate_simplified_cutoff_widget, "cutoff_widget_7", subscale_number = 7, holding_data))
  
  #Create list of input values for a subscale 
  
  input_list_7<- callModule(psychlytx::simplified_collect_holding_input, "collect_input_7", holding_data, manual_entry, aggregate_scores, mean_input_7, sd_input_7, reliability_input_7, 
                            confidence, method, cutoff_input_7, subscale_number = 7)
