                ...
                fluidRow(
                  ...
                  tabBox(id = "tabset", width = 12,
                         ...
                         tabPanel(psychlytx::simplified_show_name_UI("show_name"),
                                  ...
                                  psychlytx::simplified_pcl5_scale_UI("pcl5_scale"), #Item of the specific measure
...
server <- function(input, output, session) {
  ...
  scale_entry<- callModule(psychlytx::simplified_pcl5_scale, "pcl5_scale", client_id) #Return the raw responses to the online scale
  ...
  input_list<- reactive({ list( input_list_1(), input_list_2(), input_list_3(), input_list_4(), input_list_5() ) })  #Store each list of input values in a larger list object. If there were more than one 
